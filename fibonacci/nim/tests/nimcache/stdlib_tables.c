...
/* Command for C compiler:
   clang -c  -w  -I/Users/alextanhongpin/.choosenim/toolchains/nim-0.18.0/lib -o /Users/alextanhongpin/Documents/architecture/data-structures-and-algorithms/fibonacci/nim/tests/nimcache/stdlib_tables.o /Users/alextanhongpin/Documents/architecture/data-structures-and-algorithms/fibonacci/nim/tests/nimcache/stdlib_tables.c */
...
static N_NIMCALL(void, Marker_tySequence_Wg7nX0qLJ8wQZhTWq4sHLg)(void* p, NI op);
...
TNimType NTI_NMeFPw46ttTYWlkoE1fSPQ_;
TNimType NTI_rrmSsGcwh4hPYQjvS08J6g_;
extern TNimType NTI_wMtfD88jmrPZwfzTH9c8e9cA_;
TNimType NTI_Wg7nX0qLJ8wQZhTWq4sHLg_;
...
static N_NIMCALL(void, Marker_tySequence_Wg7nX0qLJ8wQZhTWq4sHLg)(void* p, NI op) {
	tySequence_Wg7nX0qLJ8wQZhTWq4sHLg* a;
	NI T1_;
	a = (tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*)p;
	T1_ = (NI)0;
}
...
N_LIB_PRIVATE N_NIMCALL(void, initTable_W0gqRgc1XWFZBKWTFI9cPNQ)(NI initialSize, tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ* Result) {
	nimfr_("initTable", "tables.nim");
	chckNil((void*)Result);
	genericReset((void*)Result, (&NTI_NMeFPw46ttTYWlkoE1fSPQ_));
	nimln_(324, "tables.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
	...
	(*Result).counter = ((NI) 0);
	nimln_(326, "tables.nim");
	unsureAsgnRef((void**) (&(*Result).data), (tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*) newSeq((&NTI_Wg7nX0qLJ8wQZhTWq4sHLg_), ((NI)chckRange(initialSize, ((NI) 0), ((NI) IL64(9223372036854775807))))));
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(void, enlarge_mdEBB5jtsqsxzoevkOColA)(tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ* t) {
	tySequence_Wg7nX0qLJ8wQZhTWq4sHLg* n;
	NI T1_;
	NI TM_4SoG2KRQy3oMm9aUzSLtGrA_29;
	tySequence_Wg7nX0qLJ8wQZhTWq4sHLg* T2_;
	nimfr_("enlarge", "tables.nim");
	n = (tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*)0;
	nimln_(286, "tables.nim");
	T1_ = ((*t).data ? (*t).data->Sup.len : 0);
	TM_4SoG2KRQy3oMm9aUzSLtGrA_29 = mulInt(T1_, ((NI) 2));
	n = (tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*) newSeq((&NTI_Wg7nX0qLJ8wQZhTWq4sHLg_), ((NI)chckRange((NI)(TM_4SoG2KRQy3oMm9aUzSLtGrA_29), ((NI) 0), ((NI) IL64(9223372036854775807)))));
	nimln_(287, "tables.nim");
	T2_ = (tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*)0;
	T2_ = (*t).data;
	unsureAsgnRef((void**) (&(*t).data), n);
	n = T2_;
	{
		...
		res = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(290, "tables.nim");
				{
					...
					if ((NU)(i) >= (NU)(n->Sup.len)) raiseIndexError();
					if ((NU)(i) >= (NU)(n->Sup.len)) raiseIndexError();
					rawInsert_69bTbaK7w9bJzxAF0bHaoU5Q(t, (&(*t).data), n->data[i].Field1, n->data[i].Field2, eh, j);
				}
				LA10_: ;
				nimln_(2035, "system.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, X5BX5Deq__RDMF8dZ9cRGeQi30NTpe9aMQ)(tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ* t, NI key, NU64 val) {
	...
	hc = (NI)0;
	nimln_(98, "tableimpl.nim");
	index = rawGet_pHxlA7mCdQ6JLyovZu439agtables((*t), key, (&hc));
	nimln_(307, "tables.nim");
	{
		nimln_(99, "tableimpl.nim");
		if (!(((NI) 0) <= index)) goto LA3_;
	...
	LA3_: ;
	{
		...
		nimln_(89, "tableimpl.nim");
		{
			...
			if (!T9_) goto LA10_;
			nimln_(90, "tableimpl.nim");
			enlarge_mdEBB5jtsqsxzoevkOColA(t);
			nimln_(91, "tableimpl.nim");
			index = rawGetKnownHC_4NnYqJGGQ1dChBj4ZRjLUAtables((*t), key, hc);
		}
		LA10_: ;
		nimln_(92, "tableimpl.nim");
		TM_4SoG2KRQy3oMm9aUzSLtGrA_32 = subInt(((NI) -1), index);
		index = (NI)(TM_4SoG2KRQy3oMm9aUzSLtGrA_32);
		nimln_(93, "tableimpl.nim");
		rawInsert_69bTbaK7w9bJzxAF0bHaoU5Q(t, (&(*t).data), key, val, hc, index);
		nimln_(94, "tableimpl.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, toTable_EXguNIel8wutxv7IMYPfQw)(tyTuple_YOR5jKx8MEDwDUQgT5GkXQ* pairs, NI pairsLen_0, tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ* Result) {
	...
	initTable_W0gqRgc1XWFZBKWTFI9cPNQ(T1_, Result);
	{
		NI key;
		NU64 val;
		NI i;
		...
		i = ((NI) 0);
		{
			...
			while (1) {
				...
				X5BX5Deq__RDMF8dZ9cRGeQi30NTpe9aMQ(Result, key, val);
				nimln_(2188, "system.nim");
				TM_4SoG2KRQy3oMm9aUzSLtGrA_34 = addInt(i, ((NI) 1));
				i = (NI)(TM_4SoG2KRQy3oMm9aUzSLtGrA_34);
			} LA4: ;
		}
	}
	popFrame();
...
NTI_NMeFPw46ttTYWlkoE1fSPQ_.size = sizeof(tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ);
NTI_NMeFPw46ttTYWlkoE1fSPQ_.kind = 18;
NTI_NMeFPw46ttTYWlkoE1fSPQ_.base = 0;
NTI_NMeFPw46ttTYWlkoE1fSPQ_.flags = 2;
TM_4SoG2KRQy3oMm9aUzSLtGrA_26[0] = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[8];
NTI_rrmSsGcwh4hPYQjvS08J6g_.size = sizeof(tyTuple_rrmSsGcwh4hPYQjvS08J6g);
NTI_rrmSsGcwh4hPYQjvS08J6g_.kind = 18;
NTI_rrmSsGcwh4hPYQjvS08J6g_.base = 0;
NTI_rrmSsGcwh4hPYQjvS08J6g_.flags = 3;
TM_4SoG2KRQy3oMm9aUzSLtGrA_27[0] = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[10];
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[10].kind = 1;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[10].offset = offsetof(tyTuple_rrmSsGcwh4hPYQjvS08J6g, Field0);
...
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[11].offset = offsetof(tyTuple_rrmSsGcwh4hPYQjvS08J6g, Field1);
...
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[12].offset = offsetof(tyTuple_rrmSsGcwh4hPYQjvS08J6g, Field2);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[12].typ = (&NTI_wMtfD88jmrPZwfzTH9c8e9cA_);
...
NTI_rrmSsGcwh4hPYQjvS08J6g_.node = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[9];
NTI_Wg7nX0qLJ8wQZhTWq4sHLg_.size = sizeof(tySequence_Wg7nX0qLJ8wQZhTWq4sHLg*);
NTI_Wg7nX0qLJ8wQZhTWq4sHLg_.kind = 24;
NTI_Wg7nX0qLJ8wQZhTWq4sHLg_.base = (&NTI_rrmSsGcwh4hPYQjvS08J6g_);
NTI_Wg7nX0qLJ8wQZhTWq4sHLg_.flags = 2;
NTI_Wg7nX0qLJ8wQZhTWq4sHLg_.marker = Marker_tySequence_Wg7nX0qLJ8wQZhTWq4sHLg;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[8].kind = 1;
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[8].offset = offsetof(tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ, data);
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[8].typ = (&NTI_Wg7nX0qLJ8wQZhTWq4sHLg_);
...
TM_4SoG2KRQy3oMm9aUzSLtGrA_0[13].offset = offsetof(tyObject_Table_NMeFPw46ttTYWlkoE1fSPQ, counter);
...
NTI_NMeFPw46ttTYWlkoE1fSPQ_.node = &TM_4SoG2KRQy3oMm9aUzSLtGrA_0[7];
}
